...
class PartiesControllerTest < ActionController::TestCase
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post :create, party: { host: @party.host, host_email: @party.host_email, location: @party.location, theme: @party.theme, when_held: @party.when_held }
    end
  ...
  test "should update party" do
    patch :update, id: @party, party: { host: @party.host, host_email: @party.host_email, location: @party.location, theme: @party.theme, when_held: @party.when_held }
    assert_redirected_to party_path(assigns(:party))
  end
